...
let _ =
  ...
  let cipher = m3_machine enigmaI_steckerbrett enigmaI_initial_position (Enigml.decompose plaintext) in
  print_string "Ciphertext: ";
  Enigml.print_letters cipher;
  print_newline ();
  print_string "Decryption: ";
  Enigml.print_letters @@ m3_machine enigmaI_steckerbrett enigmaI_initial_position cipher;
  print_newline ()
